...
use AngelBlanco\Mongodb\Schema\Blueprint;
...
class SchemaTest extends TestCase
{
    ...
    {
        Schema::create('newcollection_two', null, [
            'capped' => true,
            'size' => 1024,
        ]);
    ...
    public function testBluePrint(): void
    {
        ...
        Schema::collection('newcollection', function ($collection) use (
            $instance
        ) {
            $instance->assertInstanceOf(Blueprint::class, $collection);
        });
    ...
    public function testHasIndex(): void
    {
        ...
        Schema::collection('newcollection', function (
        ...
        Schema::collection('newcollection', function (
            ...
            $instance->assertFalse(
                $collection->hasIndex(['field_a_1_field_b_1'])
            );
        });
    }
