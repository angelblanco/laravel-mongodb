...
namespace AngelBlanco\Mongodb\Tests\Relations;

use Mockery;
use AngelBlanco\Mongodb\Tests\TestCase;
use AngelBlanco\Mongodb\Tests\models\Book;
use AngelBlanco\Mongodb\Tests\models\Item;
use AngelBlanco\Mongodb\Tests\models\Role;
use AngelBlanco\Mongodb\Tests\models\User;
use AngelBlanco\Mongodb\Tests\models\Group;
use AngelBlanco\Mongodb\Tests\models\Photo;
use AngelBlanco\Mongodb\Tests\models\Client;
...
class RelationsTest extends TestCase
{
    ...
    public function testMorph(): void
    {
        ...
        $photo = Photo::create([
            'url' => 'http://graph.facebook.com/john.doe/picture',
        ]);
        ...
        $photo = Photo::create([
            'url' => 'http://graph.facebook.com/jane.doe/picture',
        ]);
    ...
    public function testHasManyHas(): void
    {
        ...
        $author1
            ->books()
            ->create(['title' => 'A Game of Thrones', 'rating' => 5]);
        $author1
            ->books()
            ->create(['title' => 'A Clash of Kings', 'rating' => 5]);
