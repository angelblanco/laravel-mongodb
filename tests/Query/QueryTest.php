...
use AngelBlanco\Mongodb\Tests\models\Scoped;
...
class QueryTest extends TestCase
{
    ...
    public function testCount(): void
    {
        ...
        // Test for issue #165
        $count = User::select('_id', 'age', 'title')
            ->where('age', '<>', 35)
            ->count();
        $this->assertEquals(7, $count);
    }
    ...
    public function testUpdate(): void
    {
        ...
        $this->assertEquals(
            1,
            User::where(['name' => 'Jim Morrison'])->count()
        );
        ...
        $this->assertEquals(
            2,
            Scoped::withoutGlobalScopes()->update(['name' => 'Jimmy'])
        );
        $this->assertCount(
            2,
            Scoped::withoutGlobalScopes()
