...
use AngelBlanco\Mongodb\Tests\models\Book;
use AngelBlanco\Mongodb\Tests\models\Item;
use AngelBlanco\Mongodb\Tests\models\Soft;
use AngelBlanco\Mongodb\Tests\models\User;
use AngelBlanco\Mongodb\Tests\models\Guarded;
...
class ModelTest extends TestCase
{
    ...
    {
        User::insert([['name' => 'John Doe'], ['name' => 'Jane Doe']]);
    ...
    public function testToArray(): void
    {
        ...
        sort($keys);
        $this->assertEquals(
            ['_id', 'created_at', 'name', 'type', 'updated_at'],
            $keys
        );
    ...
    public function testDates(): void
    {
        ...
        $this->assertInstanceOf(
            UTCDateTime::class,
            $item->getRawOriginal('created_at')
        );
        $this->assertEquals(
            $item
        ...
        $this->assertLessThan(
            2,
            abs(time() - $item->created_at->getTimestamp())
        );
        ...
        $user = User::create([
            'name' => 'Jane Doe',
            'birthday' => 'Monday 8th August 2005 03:12:46 PM',
        ]);
        $this->assertInstanceOf(Carbon::class, $user->birthday);

        $user = User::create([
            'name' => 'Jane Doe',
            'birthday' => 'Monday 8th August 1960 03:12:46 PM',
        ]);
        $this->assertInstanceOf(Carbon::class, $user->birthday);
        ...
        $user = User::create([
            'name' => 'Jane Doe',
            'birthday' => new DateTime('2010-08-08'),
        ]);
        $this->assertInstanceOf(Carbon::class, $user->birthday);

        $user = User::create([
            'name' => 'Jane Doe',
            'birthday' => new DateTime('1965-08-08'),
        ]);
        $this->assertInstanceOf(Carbon::class, $user->birthday);

        $user = User::create([
            'name' => 'Jane Doe',
            'birthday' => new DateTime('2010-08-08 04.08.37'),
        ]);
        $this->assertInstanceOf(Carbon::class, $user->birthday);

        $user = User::create([
            'name' => 'Jane Doe',
            'birthday' => new DateTime('1965-08-08 04.08.37'),
        ]);
        $this->assertInstanceOf(Carbon::class, $user->birthday);

        $user = User::create([
            'name' => 'Jane Doe',
            'birthday' => new DateTime('2010-08-08 04.08.37.324'),
        ]);
        $this->assertInstanceOf(Carbon::class, $user->birthday);

        $user = User::create([
            'name' => 'Jane Doe',
            'birthday' => new DateTime('1965-08-08 04.08.37.324'),
        ]);
        $this->assertInstanceOf(Carbon::class, $user->birthday);
        ...
        $user->setAttribute(
            'birthday',
            new DateTime('2010-08-08 04.08.37.324')
        );
        $this->assertInstanceOf(Carbon::class, $user->birthday);

        $user->setAttribute(
            'birthday',
            new DateTime('1965-08-08 04.08.37.324')
        );
        $this->assertInstanceOf(Carbon::class, $user->birthday);
        ...
        $user = User::create([
            'name' => 'Jane Doe',
            'entry' => ['date' => 'Monday 8th August 2005 03:12:46 PM'],
        ]);
        $this->assertInstanceOf(
            Carbon::class,
            $user->getAttribute('entry.date')
        ...
        $user = User::create([
            'name' => 'Jane Doe',
            'entry' => ['date' => 'Monday 8th August 1960 03:12:46 PM'],
        ]);
        $this->assertInstanceOf(
            Carbon::class,
            $user->getAttribute('entry.date')
        ...
        $user = User::create([
            'name' => 'Jane Doe',
            'entry' => ['date' => new DateTime('2010-08-08')],
        ]);
        $this->assertInstanceOf(
            Carbon::class,
            $user->getAttribute('entry.date')
        ...
        $user = User::create([
            'name' => 'Jane Doe',
            'entry' => ['date' => new DateTime('1965-08-08')],
        ]);
        $this->assertInstanceOf(
            Carbon::class,
            $user->getAttribute('entry.date')
        ...
        $user = User::create([
            'name' => 'Jane Doe',
            'entry' => ['date' => new DateTime('2010-08-08 04.08.37')],
        ]);
        $this->assertInstanceOf(
            Carbon::class,
            $user->getAttribute('entry.date')
        ...
        $user = User::create([
            'name' => 'Jane Doe',
            'entry' => ['date' => new DateTime('1965-08-08 04.08.37')],
        ]);
        $this->assertInstanceOf(
            Carbon::class,
            $user->getAttribute('entry.date')
        ...
        $user = User::create([
            'name' => 'Jane Doe',
            'entry' => ['date' => new DateTime('2010-08-08 04.08.37.324')],
        ]);
        $this->assertInstanceOf(
            Carbon::class,
            $user->getAttribute('entry.date')
        ...
        $user = User::create([
            'name' => 'Jane Doe',
            'entry' => ['date' => new DateTime('1965-08-08 04.08.37.324')],
        ]);
        $this->assertInstanceOf(
            Carbon::class,
            $user->getAttribute('entry.date')
        ...
        $this->assertEquals(
            (string) $user->getAttribute('entry.date')->format('Y-m-d H:i:s'),
            $data['entry']['date']
        );
    }
    ...
    public function testGetDirtyDates(): void
    {
        ...
        $user->setRawAttributes(
            [
                'name' => 'John Doe',
                'birthday' => new DateTime('19 august 1989'),
            ],
            true
        );
