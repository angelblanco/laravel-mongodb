...
namespace AngelBlanco\Mongodb\Schema;
...
class Blueprint extends LaravelBlueprint
{
     ...
     *
     * @var \AngelBlanco\Mongodb\Connection
     */
     ...
     *
     * @var \AngelBlanco\Mongodb\Collection|\MongoDB\Collection
     */
    ...
    public function hasIndex($indexOrColumns = null)
    {
        ...
        foreach ($this->collection->listIndexes() as $index) {
            if (
                is_array($indexOrColumns) &&
                in_array($index->getName(), $indexOrColumns)
            ) {
                return true;
            }

            if (
                is_string($indexOrColumns) &&
                $index->getName() == $indexOrColumns
            ) {
                return true;
            }
        }
